...
/*
	24 Sept 2013, dimodifikasi untuk keperluan Ciliwung
...
/* Bank1 pada FSMC dibagi 4, sehingga NE_2 (punya kita) mulai pada 64000000 */
  
#define Bank1_SRAM2_ADDR  ((uint32_t)0x64000000)  
//#define Bank1_SRAM2_ADDR  ((uint32_t)0x84000000)  
...
/*
 ...
 | PD4  <-> FSMC_NOE | X PE3  <-> FSMC_A19  | PF2  <-> FSMC_A2 | PG2 <-> FSMC_A12 | 
 | PD5  <-> FSMC_NWE | X PE4  <-> FSMC_A20  | PF3  <-> FSMC_A3 | PG3 <-> FSMC_A13 | 
...
/*-- FSMC Configuration ------------------------------------------------------*/
  p.FSMC_AddressSetupTime = 2;	// 2, 3
  p.FSMC_AddressHoldTime = 0;	// 0
  p.FSMC_DataSetupTime = 2;		// 2, 4, 6 OK
  p.FSMC_BusTurnAroundDuration = 1;	//1
